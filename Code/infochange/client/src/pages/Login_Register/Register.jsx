...
export default function Register() {
    ...
    const schema3 = yup.object().shape({
        ...
        telefono: yup
            ...
            .matches(
                /^\d{9}$/,
                "El número de teléfono solo puede contener 9 dígitos"
            )
        ...
        <>
                        ...
                        {activeStep === 1 ? (
                            <Formik
                                ...
                                initialValues={{
                                    ...
                                    secureQuestion:
                                        values2?.secureQuestion || "",
                                    secureQuestionText:
                                        values2?.secureQuestionText || "",
                                }}
                                enableReinitialize={true}
                                validateOnChange={false}
                                validateOnBlur={false}
            ...
            >
                ...
                <Modal.Body id="modal-description">
                    Tu registro ha sido exitoso. ¡Bienvenido a nuestra
                    comunidad!
                </Modal.Body>
