          ...
          <div className="card-body">
              ...
              >
                <button className="btn btn-outline-danger text-center">
                  ...
                  <span className="d-sm-inline d-none">
                    Cancelar {cart.action === "in" ? "pago" : "ingreso"}
                  </span>
                </button>
              </Link>
            </div>
            <div className="row mb-3 g-4">
              <aside className="col-md-4">
                <h2 className="fs-4">
                  Pasos del {cart.action === "in" ? "pago" : "ingreso"}
                </h2>{" "}
                <ol className="list-group list-group-flush">
                  ...
                  >
                    3 - Resumen de
                    {cart.action === "in" ? " la compra" : "l ingreso"}
                  ...
                  >
                    4 - {cart.action === "in" ? "Pago" : "Ingreso"} completado
                  ...
                  {step.step === 1 ? (
                    ...
                    <ConfirmPayment
                      ...
                      nextHandler={async (method) => {
                        ...
                        if (method.type === "iban") method.type = "credit";

                        const result =
                          cart.action === "in"
                            ? await buyProduct({ cart: cart }, method)
                            : await withdrawBalance({ cart: cart }, method);
                    ...
                    <PaymentCompleted cart={cart} feedback={feedback} />
                  )}
                </div>
              </main>
            </div>
            ...
            {cart.type !== "USDT" && step.step < 4
              ? `El precio se actualizará en ${TIMEOUT - counter} segundos`
              : ""}
          </div>
        </div>
